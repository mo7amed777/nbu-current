...
import 'package:northern_border_university/view/screens/main_screens/media_center/calendar/calendar_popup_view.dart';
import 'package:northern_border_university/view/screens/main_screens/media_center/filter/filters_screen.dart';
import 'package:northern_border_university/view/screens/main_screens/media_center/list_view/media_center_list_data.dart';
import 'package:northern_border_university/view/screens/main_screens/media_center/list_view/media_center_list_view.dart';
import 'package:northern_border_university/view/widgets/appbar.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:intl/intl.dart';

class MediaCenterHomeScreen extends StatefulWidget {
  @override
  MediaCenterHomeScreenState createState() => MediaCenterHomeScreenState();
}

class MediaCenterHomeScreenState extends State<MediaCenterHomeScreen>
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            return MediaCenterListView(
                              callback: () {},
                              MediaCenterData: MediaCenterList[index],
                              animation: animation,
                              animationController: animationController!,
                            );
                          },
  ...
  Widget getMediaCenterViewList() {
    ...
    for (int i = 0; i < MediaCenterList.length; i++) {
      ...
      MediaCenterListViews.add(
        MediaCenterListView(
          callback: () {},
          MediaCenterData: MediaCenterList[i],
          animation: animation,
          animationController: animationController!,
        ),
      );
